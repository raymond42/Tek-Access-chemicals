                    ...
                    <div className="sec888" id="home" style={{ height: "100vh" }}>
                        <div className="container h100">
                            <div className="contentBox h100">
                                <div>
                                    <h1 style={{ wordSpacing: "1px", fontWeight: "400" }}>TekAccess.</h1>
                ...
                <section className="sec22">
                    <div className="about">
                        <div className="content col-sm-6">
                            ...
                            <p style={{ textAlign: "left" }}>Tekaccess is a global distribution & Trading company involved in plastic raw materials.
                             We deal in all kind of prime, near prime, off grade & recycle granules.
        We also deal in plastic regrinds, lumps & scarps.</p>
                ...
                <section className="sec33">
                    <div className="jumbotron jumbotron-fluid height100p banner" id="home">
                        <div className="container h100">
                            <div className="contentBox h100">
                                <div>
                                    <h1 style={{ wordSpacing: "1px", fontWeight: "400" }}>Our Mission</h1>
                ...
                <section className="sec55">
                    <div className="services">
                        <h1>O<span>ur Service</span>s</h1>
                    ...
                    <footer className="contact">
                        <div className="left-footer up col-sm-6">
                            ...
                            <form name="contact" method="post">
                                ...
                                <textarea className="message" name="Message" placeholder="Message here..." rows="4" style={{ background: 'transparent' }}></textarea>
                                <button className="btn-submit" type="submit"> Send Message</button>
                            </form>
                        </div>
                        <div className="right-footer up col-sm-6 bg-light-grey">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d10730.
                            ...
                            width="100%" height="100%" frameBorder="0" style={{ border: "1px solid #cecece" }}
