            ...
            <div className="container">
                <div className="row">
                    <div className="col-sm-12">
                        <ul className="sci">
                            <li className="col-sm-3"><a href="https://m.facebook.com/TekAccess-Chemical-Technologies-Limited-102012438069932/?ref=bookmarks"><i className="col-sm-3" class="fab fa-facebook-f" style={{ color: "#3b5998", fontSize: "2.3rem" }}></i><br />TekAccess Technology</a></li>
                            <li className="col-sm-3"><i class="fab fa-whatsapp" style={{ color: "#25D366", fontSize: "2.3rem" }}></i><br />+8615122871067 / +250788308294</li>
